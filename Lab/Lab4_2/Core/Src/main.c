...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, LD2_Pin|LED3_Pin|LED2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD2_Pin LED3_Pin LED2_Pin */
  GPIO_InitStruct.Pin = LD2_Pin|LED3_Pin|LED2_Pin;
...
void StartTask4(void const * argument)
{
  ...
  {
//	HAL_GPIO_TogglePin(GPIOA, GPIO_PIN_10);
	osDelay(1000);  // blink every second
  }
